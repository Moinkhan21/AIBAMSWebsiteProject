  ...
  return (
    ...
    {/* <div ref={sectionRef} className="relative w-full py-16 bg-transparent" style={{ minHeight: '100vh' }}>
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="relative w-full h-full mx-auto" style={{ maxWidth: "900px" }}>
          

          <div className="relative inset-0 grid md:grid-cols-9 md:gap-4"  >
            {Array(72).fill(0).map((_, i) => (
              <div key={i} className="bg-[#2b2b2b4f] rounded-xl w-10 h-10"></div>
            ))}
          </div>
    ...
    <div ref={sectionRef} className="relative w-full py-16 bg-transparent" style={{ minHeight: '100vh' }}>
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="relative w-full h-full mx-auto"   style={{ maxWidth: "600px" }}>
          

          <div className="relative inset-0 grid sm:grid-cols-3 sm:gap-2">
            {Array(72).fill(0).map((_, i) => (
              <div key={i} className="bg-[#2b2b2b4f] rounded-xl w-5 h-5"></div>
            ))}
          </div>
